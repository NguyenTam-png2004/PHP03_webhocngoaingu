      ...
      <div class="card-body">
        ...
        <form class="boloc" action="#" method="post">
          <div class="boloc2 form-group">
            <div class="thaotac">
              <a href="index.php?act=add_khoahoc"><input class="btn btn-gradient-primary" type="button" value="Thêm khóa học"></a>
            </div>
          ...
          <table class="table text-center table-bordered table1">
            ...
            <tbody>
              <tr>
                ...
                <td>1</td>
                <td class="btn1">
                  <a href="index.php?act=update_khoahoc"><input class="btn btn-gradient-primary btn2" type="button" value="Sửa"></a>
                  <a href="index.php?act=delete_khoahoc" onclick="return confirm('Bạn muốn xóa?')">
